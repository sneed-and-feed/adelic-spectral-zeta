...
// Module: Formalization.scratch_eval
// Imports: Init Mathlib.Analysis.InnerProductSpace.PiL2 Mathlib.Analysis.NormedSpace.OperatorNorm.Basic Formalization.CollatzRelMatrix Mathlib.Topology.ContinuousFunction.Basic Mathlib.Analysis.InnerProductSpace.Basic Mathlib.Analysis.NormedSpace.Basic Mathlib.Data.Complex.Basic
#include <lean/lean.h>
...
lean_object* initialize_Formalization_CollatzRelMatrix(uint8_t builtin, lean_object*);
lean_object* initialize_Mathlib_Topology_ContinuousFunction_Basic(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Formalization_scratch__eval(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Formalization_CollatzRelMatrix(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Topology_ContinuousFunction_Basic(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
