...
// Module: Formalization.MeanErgodic
// Imports: Init Mathlib.Analysis.InnerProductSpace.PiL2 Mathlib.Analysis.NormedSpace.OperatorNorm.Basic Mathlib.Topology.MetricSpace.Basic Mathlib.MeasureTheory.Function.LpSeminorm.ChebyshevMarkov Formalization.L2Mixing
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_MeasureTheory_Function_LpSeminorm_ChebyshevMarkov(uint8_t builtin, lean_object*);
lean_object* initialize_Formalization_L2Mixing(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Formalization_MeanErgodic(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_MeasureTheory_Function_LpSeminorm_ChebyshevMarkov(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
