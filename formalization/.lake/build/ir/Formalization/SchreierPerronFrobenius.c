...
// Module: Formalization.SchreierPerronFrobenius
// Imports: Init Mathlib.Data.Matrix.Basic Mathlib.LinearAlgebra.Matrix.Spectrum Mathlib.Analysis.InnerProductSpace.PiL2 Mathlib.Data.Real.Basic Mathlib.Algebra.Order.Group.Abs Formalization.SchreierConnectivity Formalization.SchreierSpectral SpectralPositivity.Matrix.PerronFrobenius
#include <lean/lean.h>
...
lean_object* initialize_SpectralPositivity_Matrix_PerronFrobenius(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Formalization_SchreierPerronFrobenius(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_SpectralPositivity_Matrix_PerronFrobenius(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
