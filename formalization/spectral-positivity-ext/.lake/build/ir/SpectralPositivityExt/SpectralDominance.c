...
// Module: SpectralPositivityExt.SpectralDominance
...
LEAN_EXPORT lean_object* initialize_SpectralPositivityExt_SpectralDominance(uint8_t builtin, lean_object* w) {
lean_object * res;
