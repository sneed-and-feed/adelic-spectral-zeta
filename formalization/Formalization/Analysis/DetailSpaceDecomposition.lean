  ...
  · subst h
    ...
    have h_inv : (∑ k2 : ZMod 2, hadamardInv 0 k2 * hadamardBlock k2 0) = (1 : ℚ) := by
      calc (∑ k2 : ZMod 2, hadamardInv 0 k2 * hadamardBlock k2 0)
        ...
        _ = (1 : Matrix (ZMod 2) (ZMod 2) ℚ) 0 0 := by rw [hadamard_inv_mul]
        _ = (1 : ℚ) := rfl
    simp_rw [h_inv]
    simp
  · have h_zero : ∀ k1 k2, (if i = k1 then hadamardInv 0 k2 else 0) * (if k1 = j then hadamardBlock k2 0 else 0) = (0 : ℚ) := by
      intro k1 k2
      by_cases hk1 : i = k1
      · subst hk1; simp [h]
      · simp [hk1]
  ...
  · subst h
    ...
    have h_inv : (∑ k2 : ZMod 2, hadamardInv 1 k2 * hadamardBlock k2 1) = (1 : ℚ) := by
      calc (∑ k2 : ZMod 2, hadamardInv 1 k2 * hadamardBlock k2 1)
        ...
        _ = (1 : Matrix (ZMod 2) (ZMod 2) ℚ) 1 1 := by rw [hadamard_inv_mul]
        _ = (1 : ℚ) := rfl
    simp_rw [h_inv]
    simp
  · have h_zero : ∀ k1 k2, (if i = k1 then hadamardInv 1 k2 else 0) * (if k1 = j then hadamardBlock k2 1 else 0) = (0 : ℚ) := by
      intro k1 k2
      by_cases hk1 : i = k1
      · subst hk1; simp [h]
      · simp [hk1]
  ...
  · subst h
    ...
    have h_inv : (∑ k2 : ZMod 2, hadamardInv 0 k2 * hadamardBlock k2 1) = (0 : ℚ) := by
      calc (∑ k2 : ZMod 2, hadamardInv 0 k2 * hadamardBlock k2 1)
        ...
        _ = (1 : Matrix (ZMod 2) (ZMod 2) ℚ) 0 1 := by rw [hadamard_inv_mul]
        _ = (0 : ℚ) := rfl
    simp_rw [h_inv]
    simp
  · have h_zero : ∀ k1 k2, (if i = k1 then hadamardInv 0 k2 else 0) * (if k1 = j then hadamardBlock k2 1 else 0) = (0 : ℚ) := by
      intro k1 k2
      by_cases hk1 : i = k1
      · subst hk1; simp [h]
      · simp [hk1]
...
lemma symTransition_mul_symTransition_inv_add_antisymTransition_mul_antisymTransition_inv :
  ...
  · subst h
    ...
    have h_sum : hadamardBlock j1 0 * hadamardInv 0 j2 + hadamardBlock j1 1 * hadamardInv 1 j2 = (hadamardBlock * hadamardInv) j1 j2 := by
      ...
      rw [sum_zmod_two]
    rw [h_sum, hadamard_mul_inv, Matrix.one_apply]
    simp
