...
The theoretical correctness, approximation bounds, and prefix sparsity bounds underlying the dynamic topology router and the Triton sparse kernel are formally machine-checked in Lean 4 (0 `sorry`s):
