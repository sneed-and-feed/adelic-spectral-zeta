...
$$
\mathcal{Y}_{\text{fractal}} = \left\lbrace y \in (0, y_0) \ \middle|\ \left| \prod_{n=1}^\infty \cos(2\pi \xi y s_n) \right| \ge c_0 \gt 0 \quad \text{for } |\xi| \le R \right\rbrace
$$
...
$$
E \triangle (E + h) \subset \{ x \in \mathbb{R} \mid \mathrm{dist}(x, \partial E) \le \epsilon \} = \mathcal{N}_\epsilon(\partial E)
$$
