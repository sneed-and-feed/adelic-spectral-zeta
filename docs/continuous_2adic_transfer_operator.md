...
$$\mathcal{E}_n = \left\{ f \colon \mathbb{Z}_2 \to \mathbb{C} : f(x) = f(x \bmod 2^n) \right\} = \mathrm{span} \left\{ \chi_{m, k} : 0 \le k \le n, \, 0 \le m < 2^k \right\}$$
...
$$V_0 = \mathcal{E}_0 = \mathbb{C}\mathbf{1}, \quad V_k = \mathcal{E}_k \cap \mathcal{E}_{k-1}^\perp = \mathrm{span} \left\{ \chi_{m, k} : m \in (\mathbb{Z}/2^k\mathbb{Z})^\times \right\} \quad (k \ge 1)$$
