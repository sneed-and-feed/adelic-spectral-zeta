...
$$C_1^{(n)} = \left\lbrace 1, 3, 9, \dots, 3^{2^{n-2}-1} \pmod{2^n} \right\rbrace$$

2. **Negative Cycle $C_2^{(n)}$ (the orbit of $-1$):**

$$C_2^{(n)} = -C_1^{(n)} = \left\lbrace -1, -3, -9, \dots, -3^{2^{n-2}-1} \pmod{2^n} \right\rbrace$$
...
$$u \in \left\lbrace +2^{-1/2}, -2^{-1/2} \right\rbrace \qquad \left(|u| = r_2 = 2^{-1/2} \approx 0.707107\right)$$
