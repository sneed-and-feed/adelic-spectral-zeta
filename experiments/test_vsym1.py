"""
Adelic Spectral Zeta: test_vsym1.py
"""
...
def main():
    for d in [4, 5, 6, 7, 8, 9, 10]:
        ...
        rq = rayleigh_quotient(anti, v_sym_1)
        
        print(f"--- d = {d} ---")
        print(f"sym_1 = {lambda_sym_1:.4f}, sym_2 = {lambda_sym_2:.4f}")
        print(f"RQ(v_sym_1) on anti = {rq:.4f}")
        if rq > lambda_sym_2:
            print("WINNER: v_sym_1 !")
