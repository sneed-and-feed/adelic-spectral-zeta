...
A Python library implementing the **Adèlic Spectral Triple** $(\mathcal{A}, \mathcal{H}\_{\text{glob}}, D\_{\text{glob}, \Delta})$ framework for automorphic $L$-functions. This project provides the numerical verification and quantum simulation infrastructure supporting the analytical theorems detailed in [unified_monograph.md](file:///c:/Users/x/.gemini/antigravity/scratch/adelic_spectral_zeta/docs/unified_monograph.md).
...
* **Rigidity & Extension parameter Scan**:
  ...
  ```
  Scans $\theta$ and shows how the functional equation determines $\theta\_0 = \pi$ uniquely on the critical line, and breaks off it.
